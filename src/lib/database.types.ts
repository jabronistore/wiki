...
export type Database = {
	...
	public: {
		Tables: {
			...
			findings: {
				Row: {
					administration_method: Database['public']['Enums']['administration_method'] | null;
					created_at: string;
					...
					reconstitution_solution: Database['public']['Enums']['reconstitution_solution'] | null;
		...
		Enums: {
			administration_method: 'subq' | 'nasal' | 'oral' | 'im' | 'iv' | 'topical' | 'sublingual';
			reconstitution_solution: 'bac_water' | 'sterile_water' | 'saline' | 'other';
			result_category:
				| 'weight_loss'
				| 'healing'
				| 'growth_hormone'
