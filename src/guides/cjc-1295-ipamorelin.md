---
title: 'CJC-1295 and Ipamorelin: How the Stack Works'
description: 'How CJC-1295 and Ipamorelin work together to stimulate growth hormone through two separate pathways. Dosing protocols, DAC vs no-DAC, side effects, and alternatives compared.'
date: '2026-03-24'
...
image: '/guides/cjc-1295-ipamorelin-stack.webp'
imageAlt: 'CJC-1295 and Ipamorelin peptide stack pairing illustration'

published: true
keywords: 'cjc 1295 ipamorelin, cjc-1295 ipamorelin dosage, cjc-1295 ipamorelin stack, cjc 1295 ipamorelin benefits, cjc-1295 ipamorelin side effects, cjc-1295 vs cjc-1295 dac, ipamorelin dosage'
canonical: 'https://peptide-db.com/guides/cjc-1295-ipamorelin'
showToc: true
...
relatedGuides:
  - title: 'KLOW Peptide Protocol: Ingredients, Dosing, and Research'
    ...
    excerpt: 'A research-based breakdown of the four-peptide KLOW blend.'
  - title: 'Peptides: What They Are, Side Effects, and Uses'
    slug: 'what-are-peptides'
    image: '/peptides.webp'
    excerpt: 'A comprehensive introduction to peptides and how they work.'
---
...
The [CJC-1295](/peptides/cjc-1295) and [Ipamorelin](/peptides/ipamorelin) stack is the most widely used growth hormone peptide combination. It works because the two peptides trigger GH release through completely different receptor systems, producing a combined effect greater than either one alone.
...
[View the CJC/IPA protocol data](/peptides/cjc-ipa-protocol) | [Accumulation calculator](/calculator/accumulation)
...
<MermaidDiagram
  ...
  chart={`
    graph TD
      ...
      B --> E[Ca2+ Dependent Release]
      D --> F[GH Synthesis Upregulated]
      E --> G[GH Release Amplified]
      F --> H[Pulsatile GH Secretion]
      G --> H
      H --> I[IGF-1 Elevation]
      I --> J[Muscle Protein Synthesis]
      I --> K[Fat Metabolism]
      I --> L[Recovery & Repair]
  `}
/>
...
[CJC-1295 without DAC](/peptides/cjc-1295) is a 30-amino-acid GHRH analog weighing 3,367.97 Daltons. Its half-life sits between 30 minutes and 2 hours, which matters more than it sounds.
...
[Ipamorelin](/peptides/ipamorelin) is a pentapeptide weighing 711.85 Da. Five amino acids. Small molecule, big selectivity advantage.

The selectivity is what separates Ipamorelin from older growth hormone secretagogues like [GHRP-2](/peptides/ghrp-2) and GHRP-6. All three bind the ghrelin receptor. But GHRP-2 and GHRP-6 also jack up cortisol, prolactin, and appetite. Ipamorelin doesn't. Raun et al. (1998) showed zero significant cortisol or ACTH elevation even at 200 times the effective GH-releasing dose. That study is why Ipamorelin became the default GHRP for clinical protocols.
...
CJC-1295 without DAC. The matched half-lives (30 min - 2 hours for CJC, ~2 hours for Ipamorelin) mean both peptides peak and clear together, creating a clean GH pulse. The DAC variant's continuous stimulation partially defeats the purpose of Ipamorelin's selective pulsatile release.

</Callout>

## Dosing Protocols

The [CJC/IPA protocol](/peptides/cjc-ipa-protocol) is typically dosed at a 1:1 ratio. Standard blended vials contain 2mg CJC-1295 + 2mg Ipamorelin (4mg total).
...
[Calculate your reconstitution volumes](/calculator) | [Model accumulation over time](/calculator/accumulation)
...
[Sermorelin](/peptides/sermorelin) is the original GHRH analog. It was FDA-approved in 1997 for pediatric GH deficiency (discontinued in 2008 for manufacturing reasons, not safety). Its half-life is only 10-12 minutes with 6% subcutaneous bioavailability. CJC-1295's 30-minute to 2-hour half-life and higher receptor affinity make it the more practical choice for most protocols.
...
Growth hormone promotes cell proliferation. Anyone with active cancer, a history of cancer, or unscreened tumours should not use GH secretagogues. This applies to CJC-1295, Ipamorelin, GHRP-2, Sermorelin, MK-677, and exogenous HGH alike.
...
[CJC-1295 peptide profile](/peptides/cjc-1295) | [Ipamorelin peptide profile](/peptides/ipamorelin) | [CJC/IPA protocol data](/peptides/cjc-ipa-protocol) | [Reconstitution calculator](/calculator) | [Accumulation plotter](/calculator/accumulation)
...
The standard protocol is **100-300mcg of each peptide, injected subcutaneously 1-3 times daily** on an empty stomach. The most common single-dose protocol is 200mcg of each at bedtime. Pre-mixed blended vials typically contain a 1:1 ratio. Use the [reconstitution calculator](/calculator) for precise volumes.
