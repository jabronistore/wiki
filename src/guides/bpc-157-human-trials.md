...
[Browse all healing peptides →](/peptides?category=healing)
...
A 2025 systematic review in the _American Journal of Sports Medicine_ examined all BPC-157 research for orthopaedic applications. Of 544 articles screened, only 1 clinical study met inclusion criteria. The other 35 included studies were preclinical animal models.
...
> — Vasireddi et al., American Journal of Sports Medicine, 2025
...
**Participants**: 16 patients with chronic knee pain
**Intervention**: Intraarticular injection of BPC-157 (2cc of 2000 mcg/mL solution)
...
**Participants**: 12 women (ages 39-76) with moderate to severe interstitial cystitis who had failed pentosan polysulfate treatment
**Intervention**: Intravesical (bladder) injection of 10mg BPC-157
**Follow-up**: 6 weeks
...
> "This is the first report of intravesical BPC-157 injection to help patients with moderate to severe interstitial cystitis."
> — Lee et al., Alternative Therapies in Health and Medicine, 2024
...
**Study design**: Pilot safety/pharmacokinetic study
**Participants**: 2 healthy adults (one 58-year-old male, one 68-year-old female)
**Intervention**: Day 1: 10mg IV infusion over 1 hour; Day 2: 20mg IV infusion over 1 hour
**Monitoring**: Vital signs, ECG, comprehensive metabolic panel, thyroid function
...
1. **Short-term tolerance appears acceptable**: Across all three studies (roughly 30 participants total), no adverse events were reported. This is encouraging, though the sample size is too small for definitive safety conclusions.

2. **Various administration routes seem feasible**: Intraarticular, intravesical, and intravenous administration were all tolerated without apparent issues.

3. **Some therapeutic signals exist**: The interstitial cystitis results in particular suggest potential efficacy, though this needs placebo-controlled confirmation.

### What Remains Unknown

1. **Long-term safety**: The longest follow-up was 12 months for knee pain patients. We have no data on years of use.

2. **Optimal dosing**: Without proper pharmacokinetic studies, dosing recommendations remain theoretical.

3. **Drug interactions**: No human data exists on how BPC-157 interacts with medications.

4. **Cancer risk**: BPC-157 promotes angiogenesis (blood vessel formation). Whether this could theoretically support tumor growth in humans is unknown.

5. **Efficacy for most claimed uses**: Gut healing, tendon repair, nerve regeneration—none of these common use cases have human trial data.
...
Use our [dosing calculator](/calculator) to ensure accurate reconstitution and dosing.
...
| **[TB-500](/peptides/tb-500)** | Even fewer                     | Not evaluated                | Essentially no human data    |
| **[GHK-Cu](/peptides/ghk-cu)** | Limited cosmetic studies       | Allowed in topicals          | Systemic use data lacking    |
...
1. **Placebo effect**: Expecting improvement creates real perceived improvement
2. **Selection bias**: People who feel better are more likely to report
3. **Regression to the mean**: Injuries often improve on their own
4. **Confounding variables**: Diet, rest, other treatments
5. **No verification**: Claims can't be independently confirmed
...
1. **What am I trying to treat?** Is there an evidence-based alternative?
2. **What's my risk tolerance?** Are you comfortable with unknown unknowns?
3. **Can I source quality product?** Do you have access to verified, tested peptides?
4. **What's my exit strategy?** How will you monitor for problems?
5. **Have I consulted a healthcare provider?** Particularly important if you have existing conditions
...
[Learn more about BPC-157 →](/peptides/bpc-157)

[Read about BPC-157 side effects →](/guides/bpc-157-side-effects)
